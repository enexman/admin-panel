...
import ErrorMessage from '../components/overall/error_message'
...
class App extends Component {
  ...
  render () {
    ...
    return (
      <div>
        <ErrorMessage visible={this.props.spinner.errorVisible} error={this.props.spinner.errorMessage} />
        <NetworkSpinner visible={this.props.spinner.networkActive} message={this.props.app.networkMessage}/>
...
function mapStateToProps ({app, auth, values, spinner}) { return {app, auth, values, spinner} }
