...
import { fnRestorePassword } from '../../actions'

const LOGO = require('../../images/logo2x.png')
...
class ResPass extends Component {
  ...
  fnRestorePasswordLocal () {
    this.props.fnRestorePassword(this.state.Email)
    this.setState({Email: ''})
  }
...
export default connect(mapStateToProps, {fnRestorePassword})(ResPass)
