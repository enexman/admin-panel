...
import { editWorkItem } from '../../../actions'

import { ValidatorError } from '../../overall/validators'

class EditWorkElem extends Component {
  ...
  fnEditItems (uid, key, value) {
    this.props.editWorkItem(this.props.data.id, {[key]: value})
    this.close()
  }
...
export default connect(null, { editWorkItem }, null, {withRef: true})(EditWorkElem)
