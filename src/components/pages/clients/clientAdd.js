...
import { fnChangeNavigationBar, addClientItem, loadImages } from '../../../actions'
...
class ClientAdd extends Component {
  ...
  fnAddItem () {
    this.props.addClientItem(this.state.Name, this.state.Comment, this.state.ImageId)
  }
      ...
      <div>
        <Paper style={ADD_CLIENT_STYLE.paper} zDepth={1} children={
          <ValidateGroup ref="Group">
            ...
            <Row>
              <Col xs={6}>
                <CommentInput value={this.state.Comment} onChange={::this.fnChange}/>
              </Col>
              <Col xs={6}>
                <SelectField
        ...
        <UploadImages dir="clients"/>
      </div>
    )
  }
}

export default connect(({images}) => ({images}), {fnChangeNavigationBar, addClientItem, loadImages})(ClientAdd)
