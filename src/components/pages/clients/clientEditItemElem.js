...
import { editClientItem } from '../../../actions'

import { ValidatorError } from '../../overall/validators'

class EditClientElem extends Component {
  ...
  fnEditItems (uid, key, value) {
    this.props.editClientItem(this.props.data.id, {[key]: value})
    this.close()
  }
...
export default connect(null, { editClientItem }, null, {withRef: true})(EditClientElem)
