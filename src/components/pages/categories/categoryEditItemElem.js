...
import { editCategoryItem } from '../../../actions'
import { ValidatorError } from '../../overall/validators'

class EditCategoryElem extends Component {
  ...
  fnEditItems (uid, key, value) {
    this.props.editCategoryItem(this.props.data.id, {[key]: value})
    this.close()
  }
...
export default connect(null, { editCategoryItem }, null, {withRef: true})(EditCategoryElem)
