...
import { fnChangeNavigationBar, addCategoryItem, loadImages } from '../../../actions'
...
class CategoryAdd extends Component {
  ...
  fnAddItem () {
    this.props.addCategoryItem(this.state.Name, this.state.ImageId)
  }
  ...
  render () {
    ...
    return (
      <div>
        ...
        <UploadImages dir="categories"/>
      </div>
    )
  }
}

export default connect(({images}) => ({images}), {fnChangeNavigationBar, addCategoryItem, loadImages})(CategoryAdd)
